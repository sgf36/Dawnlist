...
the Microsoft Store's own subscription on `store_iap`, Apple's on `mas`, a
Paddle licence on `direct` — and
...
FLAGS = {
    # Paddle declined dawnlist.spencerfields.com on 2026-09-11 and the appeal
    # was rejected on 2026-09-15. The Microsoft Store subscription (IAP) is
    # the only Windows Store till going forward.
...
def variant() -> str:
    """'store_iap', 'mas', 'direct', 'none' or 'ambiguous'.
